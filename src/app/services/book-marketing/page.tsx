        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-32 pb-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm">
              ...
              <span className="text-white text-xs font-bold uppercase tracking-widest">Book Marketing</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight tracking-tight">
              Making your Words Available everywhere.
            </h1>
          ...
          <div className="lg:col-span-5 flex justify-end">
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 md:p-10 w-full max-w-md border border-white/20 relative">
              ...
              <p className="text-sm text-slate-500 mb-8">Consult with a marketing expert for free.</p>
  ...
  <option value="audio-book">Audio Book</option>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center bg-white">
        <div className="space-y-6">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight">
            Sales-Centric Digital Content Marketing
          </h2>
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Our Concentric Approach</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <h3 className="font-bold text-slate-900 text-lg mb-3">Targeted Ads</h3>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <h3 className="font-bold text-slate-900 text-lg mb-3">Social Media & PR</h3>
              <p className="text-sm text-slate-600 leading-relaxed max-w-xs mx-auto">
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <h3 className="font-bold text-slate-900 text-lg mb-3">SEO & Websites</h3>
              <p className="text-sm text-slate-600 leading-relaxed max-w-xs mx-auto">
      ...
      <section className="py-24 bg-slate-900 text-white border-y-[6px] border-orange-600">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h4 className="text-orange-500 font-bold uppercase tracking-widest text-sm mb-4">Promotions</h4>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">Our Marketing Process</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">Market Research & Audience</h4>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">Strategic Planning & Asset Creation</h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">Execution & Promotional Push</h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">Analytics & Optimization</h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
