    ...
    <div className="w-full bg-slate-50 min-h-screen font-sans">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-32 pb-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm">
              ...
              <span className="text-white text-xs font-bold uppercase tracking-widest">Author Website Design</span>
            </div>
          ...
          <div className="lg:col-span-5 flex justify-end">
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 md:p-10 w-full max-w-md border border-white/20 relative">
              ...
              <p className="text-sm text-slate-500 mb-8">Consult with a web expert for free.</p>
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">Built for Readers, Designed for Sales</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <h3 className="font-bold text-slate-900 text-lg mb-3">Responsive & Mobile First</h3>
              <p className="text-sm text-slate-600 leading-relaxed max-w-xs mx-auto">
                We ensure your website looks stunning and functions perfectly on smartphones, tablets, and massive desktop monitors alike.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <h3 className="font-bold text-slate-900 text-lg mb-3">E-Commerce Integration</h3>
              <p className="text-sm text-slate-600 leading-relaxed max-w-xs mx-auto">
                We can integrate secure payment gateways so you can sell physical books, digital downloads, and merchandise directly to your fans.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <h3 className="font-bold text-slate-900 text-lg mb-3">SEO & Lead Generation</h3>
              <p className="text-sm text-slate-600 leading-relaxed max-w-xs mx-auto">
                We optimize your site for search engines. Capture reader emails effortlessly to build a loyal fanbase for your next book launch.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-slate-900 text-white border-y-[6px] border-orange-600">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h4 className="text-orange-500 font-bold uppercase tracking-widest text-sm mb-4">Web Showcase</h4>
          <h2 className="text-3xl md:text-5xl font-black mb-16 tracking-tight">Our Website Portfolio</h2>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">Our Web Design Process</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">Discovery & Wireframing</h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    We start by discussing your brand, genre, and goals. We map out the site architecture and create wireframes to determine exactly where your books, bio, and lead captures will sit.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">UI/UX Design Mockups</h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">Development & Integration</h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">Testing, SEO & Launch</h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
