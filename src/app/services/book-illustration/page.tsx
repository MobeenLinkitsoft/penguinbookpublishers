        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-32 pb-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight tracking-tight">
              Book Illustration Services at Penguin Book Publishers.
            </h1>
            <p className="text-lg text-slate-300 max-w-xl leading-relaxed font-medium">
              ...
              tailored for children's books, graphic novels, and custom cover
              art.
            </p>
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {/* Box 1 */}
            <div className="bg-white p-10 rounded-2xl shadow-sm hover:shadow-xl transition-all border border-slate-100 text-center group">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight">
              Our Process For Book Illustrations
            </h2>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    ...
                    establish the character descriptions and environmental
                    settings.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    ...
                    composition, pacing, and character expressions early in the
                    process.
                  </p>
                </div>
              </div>
