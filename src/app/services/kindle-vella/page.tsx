    ...
    <div className="w-full bg-slate-50 min-h-screen font-sans">
      ...
      <section className="py-20 bg-slate-50 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <p className="text-orange-600 font-bold text-sm uppercase tracking-wider">Vella Mechanics</p>
      ...
      <section className="py-24 bg-slate-900 text-white border-y-[6px] border-orange-600">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h4 className="text-orange-500 font-bold uppercase tracking-widest text-sm mb-4">Serials</h4>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 md:gap-6">
            {portfolioBooks.map((cover, i) => (
              <div key={i} className="aspect-square relative rounded-xl overflow-hidden shadow-2xl border border-slate-700 group cursor-pointer hover:border-orange-500 transition-colors">
                <Image 
                  src={cover} 
