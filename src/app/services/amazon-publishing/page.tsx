        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-32 pb-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <p className="text-lg text-slate-300 max-w-xl leading-relaxed font-medium">
              Navigate the complexities of Kindle Direct Publishing with ease.
              Our experts handle the formatting, metadata optimization, and
              backend uploads to ensure your book dominates Amazon's global
              marketplace.
            </p>
          ...
          <div className="lg:col-span-5 flex justify-end">
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 md:p-10 w-full max-w-md border border-white/20 relative">
              ...
              <p className="text-sm text-slate-500 mb-8">
                Consult with an Amazon publishing expert for free.
              </p>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center bg-white">
        <div className="space-y-6">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight">
            Ideal and Robust Publishing Process on Amazon.
          </h2>
          <p className="text-slate-600 leading-relaxed text-sm md:text-base">
            Publishing on Amazon is more than just uploading a file. It requires
            strategic categorization, keyword indexing, and perfect formatting
            to ensure the Kindle algorithm favors your title.
          </p>
          <p className="text-slate-600 leading-relaxed text-sm md:text-base">
            Our publishing executives manage the entire backend. We configure
            your KDP dashboard, set up author central accounts, assign ISBNs,
            and execute a launch strategy that maximizes your visibility across
        ...
        <div className="relative flex justify-center items-center h-[400px]">
          ...
          <div className="relative w-full max-w-md h-full flex items-center justify-center">
            <div className="absolute w-40 h-60 bg-slate-800 rounded shadow-xl transform -rotate-12 -translate-x-12 z-10 border border-slate-700 overflow-hidden">
              <Image
                src="/Book/Book55.jpg"
                alt="Book 1"
                fill
            ...
            <div className="absolute w-48 h-72 bg-white rounded shadow-2xl z-20 border border-slate-200 transform -translate-y-4 overflow-hidden">
              <Image
                src="/Book/Book57.jpg"
                alt="Book 3 Main"
                fill
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tight">
              Speak to our professional executives
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <p className="text-sm text-slate-600 leading-relaxed max-w-xs mx-auto">
                We consult on pricing, KDP Select enrollment, and metadata setup
                (7 keywords and 2 categories) to maximize your sales and royalty
                percentages.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 text-center space-y-6">
          ...
          <p className="text-orange-600 font-bold text-sm uppercase tracking-widest">
            Call us right now. Let's get your manuscript trending on Amazon's
            charts!
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              <div className="flex gap-6">
                <div className="text-7xl font-bold text-slate-200 font-serif leading-none shrink-0 w-16 text-center">
                  1
                </div>
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    ...
                    ensure it meets Amazon’s community guidelines and content
                    standards, preparing it for the backend process.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    ...
                    residual errors. Amazon readers are highly critical of
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    ...
                    PDF dimensions for KDP paperback and hardcover.
                  </p>
                </div>
              </div>
