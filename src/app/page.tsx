...
export default function Home() {
  ...
  return (
    <div className="w-full bg-slate-50 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100 flex flex-col md:flex-row items-center gap-12 mb-16">
            ...
            <div className="w-full md:w-2/3 space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                <button
                  onClick={() => setIsModalOpen(true)}
                  className="bg-orange-600 text-white px-8 py-3 rounded font-bold hover:bg-orange-700 transition text-sm uppercase"
                >
                  Get A Quote
                </button>
                <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="w-20 h-20 bg-slate-50 text-orange-600 rounded-full flex items-center justify-center mb-6 shadow-inner">
                  {feature.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6 relative z-10">
            ...
            <div className="flex gap-4 pt-6">
              <button className="bg-orange-600 text-white px-8 py-3 rounded font-bold hover:bg-orange-700 transition uppercase tracking-widest text-sm">
                Read More
              </button>
              <button
                onClick={() => setIsModalOpen(true)}
      ...
      {/* ================= 5. INFINITE LOGOS ================= */}
      <section className="bg-orange-600 py-8 border-y-4 border-orange-650 overflow-hidden">
        <style>{`
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="flex justify-center items-center">
            ...
            <div className="relative w-[350px] h-[350px] border border-slate-600 rounded-full flex items-center justify-center">
              ...
              <div className="relative w-24 h-24 bg-orange-600 rounded-lg flex items-center justify-center shadow-[0_0_40px_rgba(234,88,12,0.4)] z-10 rotate-45">
                <BookOpen size={40} className="text-white -rotate-45" />
              </div>
              {/* Nodes */}
              <div className="absolute top-4 left-1/2 -translate-x-1/2 w-10 h-10 bg-slate-800 rounded-full border border-orange-500 flex items-center justify-center">
                <Globe size={18} className="text-orange-500" />
              </div>
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-10 h-10 bg-slate-800 rounded-full border border-orange-500 flex items-center justify-center">
                <Target size={18} className="text-orange-500" />
              </div>
              <div className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-slate-800 rounded-full border border-orange-500 flex items-center justify-center">
                <TrendingUp size={18} className="text-orange-500" />
              </div>
              <div className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-slate-800 rounded-full border border-orange-500 flex items-center justify-center">
          ...
          <div className="space-y-6">
            <h4 className="text-orange-500 font-bold tracking-widest text-sm uppercase">
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden border-t border-slate-200">
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="relative">
            {/* Dashed Line */}
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-0.5 border-l-2 border-dashed border-orange-300 -translate-x-1/2"></div>
            ...
            <div className="space-y-12 md:space-y-24">
              {[
                ...
                >
                  ...
                  >
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100 max-w-sm w-full relative group hover:border-orange-500 transition-colors">
                      <div className="w-16 h-16 bg-orange-50 text-orange-600 rounded-full flex items-center justify-center mb-4 mx-auto md:mx-0 group-hover:bg-orange-600 group-hover:text-white transition-colors">
                        {step.icon}
                      </div>
                  ...
                  <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-6 h-6 bg-orange-600 rounded-full border-4 border-white shadow-md z-10"></div>
                </div>
              ))}
            </div>

            <div className="flex justify-center pt-16">
              <button className="bg-orange-600 text-white px-10 py-4 rounded font-bold hover:bg-orange-700 transition uppercase tracking-widest text-sm shadow-xl">
                Start Your Project
              </button>
            </div>
          </div>
          ...
          <div className="relative bg-slate-900 text-white p-10 md:p-16 rounded-3xl shadow-2xl">
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between px-4 md:-mx-6">
              <button
                ...
                className="w-12 h-12 bg-white text-slate-900 rounded-full flex items-center justify-center hover:bg-orange-500 hover:text-white transition-colors shadow-lg"
              >
                <ChevronLeft size={24} />
              </button>
              <button
