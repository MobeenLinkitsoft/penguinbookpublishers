...
import { 
  Video, PlayCircle, MessageSquare, Phone, Mail 
} from "lucide-react";
        ...
        <div className="relative flex justify-center items-center h-[400px]">
          <div className="relative w-full max-w-[450px]">
             ...
             <div className="aspect-video bg-slate-900 rounded-xl shadow-2xl flex items-center justify-center relative overflow-hidden group">
               ...
               <div className="absolute w-20 h-20 bg-white/20 backdrop-blur rounded-full flex items-center justify-center border-2 border-white/50 group-hover:bg-orange-600/90 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-slate-50 p-8 rounded-2xl border border-slate-100 text-center hover:border-orange-500 transition-colors">
                <h3 className="font-bold text-slate-900 text-xl mb-4">Step {String(idx+1).padStart(2, '0')}</h3>
                <h4 className="font-bold text-orange-600 mb-2">{step.title}</h4>
