        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-32 pb-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <p className="text-lg text-slate-300 max-w-xl leading-relaxed font-medium">
              A book is constantly judged by its cover. Let our award-winning
              graphic designers craft a custom, stunning book cover that
              captures your story's essence and dominates digital and physical
              bookshelves.
            </p>
          ...
          <div className="lg:col-span-5 flex justify-end">
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 md:p-10 w-full max-w-md border border-white/20 relative">
              ...
              <p className="text-sm text-slate-500 mb-8">
                Consult with a design expert for free.
              </p>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center bg-white">
        <div className="space-y-6">
          ...
          <p className="text-slate-600 leading-relaxed text-sm md:text-base">
            Exceptional graphic designers, artists, and typographers at our firm
            understand exactly what it takes to visually captivate an audience.
            We incorporate psychological color theory, genre-specific
            typography, and stunning imagery to ensure your book grabs attention
            instantly.
          </p>
        ...
        <div className="relative flex justify-center items-center h-[400px]">
          {/* Overlapping Real Book Covers */}
          <div className="relative w-full max-w-md h-full flex items-center justify-center">
            <div className="absolute w-56 h-80 rounded-lg shadow-2xl overflow-hidden transform -rotate-12 hover:-rotate-6 transition duration-500 border-4 border-white z-0 -translate-x-12">
              <Image
                src="/Book/Book23.jpg"
                alt="Cover Design 1"
                fill
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <p className="text-sm text-slate-600 leading-relaxed max-w-xs mx-auto">
                We collect your ideas, synopsis, and genre preferences to create
                a mood board. Our designers explore typography and imagery that
                seamlessly aligns with your narrative.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <p className="text-sm text-slate-600 leading-relaxed max-w-xs mx-auto">
                We provide multiple initial cover concepts. Through layered
                composition and custom illustrations, we begin building the
                visual hierarchy of your front, back, and spine.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 text-center hover:shadow-xl transition-all group">
              ...
              <p className="text-sm text-slate-600 leading-relaxed max-w-xs mx-auto">
                After your feedback, we tweak colors and fine-tune details.
                Finally, we deliver high-resolution files perfectly formatted
                for Amazon KDP, IngramSpark, and hardcover printing.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-6 text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 uppercase tracking-tight">
            Let us design your masterpiece
          </h2>
          <p className="text-orange-600 font-bold text-sm uppercase tracking-widest">
            Call us right now. Don't let your book be judged by a bad cover!
          </p>
            ...
            <div className="space-y-10">
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">
                    Creative Brief & Concept Art
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    We start by gathering your ideas, manuscript details, and
                    genre expectations. Our team then generates initial concept
                    art and mood boards to align with your vision.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Selecting the right font is as crucial as the imagery. We
                    blend custom typography with dynamic imagery, ensuring the
                    title and author name pop at thumbnail sizes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    We present the draft concepts to you. We welcome your
                    feedback and iterate on colors, layouts, and graphical
                    elements until the cover matches your absolute perfection.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="text-xl font-bold text-slate-900 mb-2">
                    Final Files & 3D Mockups
                  </h4>
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Upon approval, we deliver print-ready PDFs (with spine and
                    back calculated to your page count), eBook JPEGs, and
                    stunning 3D mockups for your marketing campaigns.
                  </p>
                </div>
              </div>
            </div>
